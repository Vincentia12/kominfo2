...
<div>
    ...
    <div class="row">
        <table border="0">
            ...
            <tr>
                <td style="text-align:justify;" width="540">"{{$pengadaan->pengadaan->jenis_pengadaan}}"</td>
            </tr>
        </table>
    </div>
    <div>
    ...
    <div class="row">
        <table border="0">
            ...
            <tr>
                <td width="540">Tersedianya {{$pengadaan->pengadaan->jenis_pengadaan}} tepat waktu sesuai jadwal yang ada
                </td>
            </tr>
        </table>
    </div>
